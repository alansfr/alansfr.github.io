...
**Note on broken links** We are in the process of updating broken links. However if a link to an external site is now dead, there is almost certainly a copy saved in [The Internet Archive](https://web.archive.org) or [archive.today](https://archive.ph). The latter is generally faster, but less comprehensive.
{: .notice--danger}

## Glenn's former law-firm partner lets rip

We start with the most revealing page of all. Unlike most of them, this isn't a web-page **about** Glenn at all: it's one of his _Intercept_ articles. The interesting part is not the article, but the comments section. The comments section is long. The best place to start is by searching for the word **Mona** and skipping the first few occurences until she speaks herself with the words "This is actually a question that merits answering".


Mona Holland is the _Holland_ of _Greenwald, Christoph and Holland_, Glenn's own small firm. No one disputes this is really Mona, not even Glenn when he enters the conversation. 
...
- ``Aug 23, 2013`` Joshua Frost's blog warns about Glenn in: [A Pathetic Slap from a Lying Bully](https://archive.ph/84Yd2) *UPDATED LINK*{: .new }
...
- ``January 26, 2012`` Jeffrey Goldberg for The Atlantic: [More on Glenn Greenwald, 'Israel-Firsters,' and Idiot Editors](https://www.theatlantic.com/national/archive/2012/01/more-on-glenn-greenwald-israel-firsters-and-idiot-editors-updated/251852/)
...
_Note there are two significant commentators called "Charles Johnson". One is a white supremacist driving with Matt Gaetz on [this page](https://www.theblockbeats.info/en/news/46485). This is the other one._{: .notice--primary}  
...
- ``Dec 15, 2013`` Daily Kos Community describes GG as a "Koch Libertarian - Faux progressive Ratfucker": [Glenn Greenwald advocates letting Republicans destroy the country](https://www.dailykos.com/stories/2013/12/15/1262880/-Glenn-Greenwald-advocates-letting-Republicans-destroy-the-country). This cites:
...
``July 23, 2020`` Replying to Ezra Klein: _Wow, there are more sockpuppets here than a Glenn Greenwald slumber party._ [When Tucker Carlson asked to join Journolist](https://archive.ph/83OB) *UPDATED LINK*{: .new }
